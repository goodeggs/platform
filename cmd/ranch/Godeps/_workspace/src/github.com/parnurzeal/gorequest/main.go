...
import (
	...
	"github.com/goodeggs/platform/cmd/ranch/Godeps/_workspace/src/github.com/moul/http2curl"

	"github.com/goodeggs/platform/cmd/ranch/Godeps/_workspace/src/golang.org/x/net/publicsuffix"
)
